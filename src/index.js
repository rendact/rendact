    ...
    return (
      <BrowserRouter>
        <div id="router" style={{ height: "100vh" }}>
          <MatchWhenAuthorized
            pattern="/admin/:page?/:action?/:postId?"
            component={Routes.Admin}
          />
          <Match
            pattern="/page/:postId?/:param1?/:param2?"
            component={Routes.ThemeSingle}
          />
          <Match
            pattern="/post/:postId?/:param1?/:param2?"
            component={Routes.ThemeSingle}
          />
          <Match
            pattern="/blog/:postId?/:param1?/:param2?"
            component={Routes.ThemeBlog}
          />
          <Match
            pattern="/category/:categoryId?/:param1?/:param2?"
            component={Routes.ThemeBlog}
          />
