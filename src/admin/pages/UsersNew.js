...
let NewUser = React.createClass({
  ...
  handleSubmitBtn: function(v) {
    ...
    this.props.client
      ...
      .then(({ data }) => {
        // me.disableForm(true);
        var p =
          me.props.mode === "update"
            ? data.updateUser.changedUser
            : data.createUser.changedUser;
        var here = me;
        ...
        if (isMetaEmpty) {
          if (me.props.mode === "create") me.resetForm();
          else me.notification.removeNotification("saving");
          ...
          var existMetaList = _.map(p.meta.edges, function(item) {
            return item.node.item;
          });
          var qry2 = Query.createUpdateUserMetaMtn(
            p.id,
            existMetaList,
            userMetaData0
          );
          ...
          me.props.client
            ...
            .then(data => {
              ...
              if (here.props.mode === "create") here.resetForm();
              else here.disableForm(false);
            });
        }
        me.disableForm(false);
      })
  ...
  handleGeneratePassword: function(event) {
    ...
    this.props.change("new-password-2", pw);
  ...
  handlePasswordChange: function(score, password) {
    var password = score.password;
    this.setState({ passwordTemp: password });
    if (password) {
  ...
  handleConfirmPasswordChange: function(e) {
    ...
    if (value !== this.state.passwordTemp) {
  ...
  checkUsername: function(username) {
    ...
    this.props.client
      ...
      .then(data => {});
    riques(Query.checkUsernameQry(username), function(error, response, body) {
  ...
  checkEmail: function(email) {
    ...
    //this.disableForm(true);
    riques(Query.checkEmailQry(email), function(error, response, body) {
      if (!error && !body.errors && response.statusCode === 200) {
            ...
            <h1>
              ...
              {this.props.mode === "update" && (
                <small style={{ marginLeft: 5 }}>
                  <button
                    className="btn btn-default btn-primary add-new-post-btn"
          ...
          <section className="content">
            <div className="row">
              <div className="col-md-8">
                <section className="content">
                  <form
                    onSubmit={this.props.handleSubmit(this.handleSubmitBtn)}
                  ...
                  >
                    ...
                    <div className="form-group">
                      <label htmlFor="tagline" className="col-md-3">
                      ...
                      <div className="col-md-9">
                        <div className="form-inline">
                          <Field
                            ...
                            disabled={
                              this.props.mode === "update" ? true : false
                            }
                          />
                        ...
                        <p className="help-block">
                          {this.props.usernameTextBlock}
                        </p>
                      </div>
                    </div>

                    <div className="form-group">
                      <label htmlFor="dateOfBirth" className="col-md-3">
                        Date of Birth
                      </label>
                      <div className="col-md-9">
                        <DateTime
                    ...
                    <div className="form-group">
                      <label htmlFor="homeUrl" className="col-md-3">
                    ...
                    <div className="form-group">
                      <label htmlFor="bio" className="col-md-3">
                        Biography
                      </label>
                      <div className="col-md-9">
                        <Field
                    ...
                    <div className="form-group">
                      <label htmlFor="timezone" className="col-md-3">
                        Timezone
                      </label>
                      <div className="col-md-9">
                        <TimezonePicker
                    ...
                    <div className="form-group">
                      <label htmlFor="website" className="col-md-3">
                        Website
                      </label>
                      <div className="col-md-9">
                        <Field
                          ...
                          type="text"
                          className="form-control"
                          placeholder="example: www.ussunnah.com"
                          className="form-control"
                        />
                        <p className="help-block">
                          {this.props.websiteTextBlock}
                        </p>
                      </div>
                    </div>

                    <div className="form-group">
                      <label htmlFor="facebook" className="col-md-3">
                        Facebook Account
                      </label>
                      <div className="col-md-9">
                        <Field
                          ...
                          validate={[facebook]}
                          className="form-control"
                          placeholder="example: www.facebook.com/ussunnah"
                        />
                        <p className="help-block">
                          {this.props.facebookTextBlock}
                        </p>
                      </div>
                    </div>

                    <div className="form-group">
                      <label htmlFor="twitter" className="col-md-3">
                        Twitter Account
                      </label>
                      <div className="col-md-9">
                        <Field
                          ...
                          type="text"
                          className="form-control"
                          placeholder="example: www.twitter.com/ussunnah"
                          className="form-control"
                        />
                        <p className="help-block">
                          {this.props.twitterTextBlock}
                        </p>
                      </div>
                    </div>

                    <div className="form-group">
                      <label htmlFor="linkedin" className="col-md-3">
                        Linkedin Account
                      </label>
                      <div className="col-md-9">
                        <Field
                          ...
                          component={renderField}
                          type="text"
                          placeholder="example: linkedin.com/in/ussunnah"
                          className="form-control"
                        />
                        <p className="help-block">
                          {this.props.linkedinTextBlock}
                        </p>
                      </div>
                    </div>

                    {this.props.mode === "create" && [
                      <h4 key="1" style={{ marginBottom: 20 }}>
                        Password
                      </h4>,
                    ...
                    {this.props.mode === "update" && [
                      ...
                      <div key="3" className="form-group">
                        <label htmlFor="old-password" className="col-md-3">
                          Old password
                        </label>
                        <div className="col-md-9">
                          <Field
                    ...
                    <div className="form-group">
                      ...
                      <div className="col-md-9">
                        ...
                        <button
                          ...
                          style={{ height: 52, marginLeft: 5, marginBottom: 5 }}
                        >
                          Generate
                        </button>
                        <div>
                    ...
                    <div className="form-group">
                      <label htmlFor="new-password-2" className="col-md-3">
                      ...
                      <div className="col-md-9">
                        <Field
                          ...
                          className="form-control"
                          style={{ width: 300 }}
                          disabled={!this.props.passwordActive}
                        />
  ...
  props: ({ ownProps, data }) => {
    if (data.viewer) {
      ...
      for (var i = 0; i < data.viewer.allRoles.edges.length; i++) {
        ...
        if (item.node.name === "Owner" && !Config.adminMode) continue;
