            ...
            <div className="row">
              <div className="col-md-8">
                ...
                <div className="form-group">
                  ...
                  <div className="col-md-9">
                    <Field name="new-password-2" onChange={this.handleConfirmPasswordChange} validate={required} component={renderField} type="password" className="form-control" style={{width:300}} disabled={!this.props.passwordActive}/>
                    {!this.state.passwordMatch && this.state.passwordTemp && <p className="help-block" style={{color:"red"}}>Password did not match</p>}
                  </div>
                </div>
